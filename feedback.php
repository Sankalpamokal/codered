...
<header id="indexheader" style="margin-bottom: 0px;" >
	...
	<ul id="ulindex" style="padding-top: 8px;padding-bottom: 8px;">
		...
		<li class="liindex"><a href="feedback.php" class="active">Feedbacks</a></li>
...
<br/>
<div class="container">
<center><h2 style="font-size:2.5vw;color:black;">Feedbacks by the users</h2></center>
<?php
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td><a style=text-decoration:none; href=fmail.php?id=".$row['cemail']." target=_blank>Message</a></td>";			
