...
<div class="limiter" style="margin-top: 0px;">
	<div class="container">
        ...
        <input type="radio" name="source" value="individual" id="individual" onclick="javascript:window.location.href='login.php'; return false;" checked >Individual   
		...
		<!--		<div class="text-right">
				...
				<div class="containerform" >
					<div class="loginbtn" >
						...
						<input type="submit" class="loginbtntxt" value="Login" >
					</div>
				</div>
