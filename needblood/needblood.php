...
<div class="container">
	...
	<label for="Select Country">Select Country</label>
        ...
        <select id="city" name="city">
			<option value="select">----Select City----</option>
                        ...
                        <select name="bgroup" id="bgroup"> 
 						<option value="select">----Select B Group----</option>
        ...
        <br/>
<br/>
        <input type="submit" id="submit" value="Submit" style="font-family:Comic Sans MS;"><br/><br/><br/>
    </form>
	<?php
...
$sql = "SELECT indid, fname, username, mobile, bgroup FROM individual WHERE country='$country' AND state='$state' AND city='$city' AND bgroup='$bgroup'";
